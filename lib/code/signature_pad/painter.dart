...
import 'package:auto_glass_crm/code/signature_pad/colors.dart';
import 'package:auto_glass_crm/code/signature_pad/point.dart';
...
class SignaturePadPainter extends CustomPainter {
  ...
  Future<Uint8List> getPng() async {
    ...
    var image = await picture.toImage(lastSize.width.round(), lastSize.height.round());
